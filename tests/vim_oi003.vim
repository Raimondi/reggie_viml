...
3
normal 0dik
call vimtap#Is(getline(1,line('$')), ['" Sample 4', 'let i = 2', 'while i > 2', 'ndwhile'], 'Check if the selection from "while" was correct.')
undo
13
normal 0dik
call vimtap#Is(getline(1,line('$')), ['" Sample 4', 'let i = 2', 'while i > 2', 'ndwhile'], 'Check if the selection from "endwhile" was correct.')
undo
5
normal 0dik
